...
def find_scenes(video_path, min_scene_length=1, abs_min=0.9, abs_max=0.98, find_subscenes=True, max_subscenes_per_minute=12):
    """
...
def scene_to_text(scenes):
    ...
    frequent_patterns = utils.sequential_pattern_mining(transactions, 2)
    return scene_text_dict, frequent_patterns


# file_name = "CS 412_Lecture12_Trim_Trim.mov"
# scenes = find_scenes(file_name, min_scene_length=1, abs_min=0.75, abs_max=0.98, find_subscenes=True, max_subscenes_per_minute=12)
#
# scene_text_dict = scene_to_text(scenes)
#
